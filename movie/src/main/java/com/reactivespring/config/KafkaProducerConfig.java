...
import com.reactivespring.serializer.MovieDtoSerializer;
...
public class KafkaProducerConfig
{
  ...
  public ProducerFactory<String, MovieDto> movieProducerFactory() {
    ...
    configProps.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, MovieDtoSerializer.class);
    return new DefaultKafkaProducerFactory<>(configProps);
  }

  @Bean
  public KafkaTemplate<String, MovieDto> movieDtoKafkaTemplate() {
